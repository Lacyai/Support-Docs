...
title: "Cost Overview"
icon: "dollar-sign"
description: "Understand the main components of Lacy.ai pricing, including call minutes, number rentals, and optional fees"
---

Lacy.ai uses a **credit/minute system** to track usage for both AI processing and carrier network fees. Here's how it breaks down:
...
1. **AI Cost**
   ...
   - Rate depends on your plan (Core, Pro+, Business+, etc.).
...
1. **Pick a Plan**: Decide on Core, Pro+, or Business+-higher plans have cheaper AI rates.
2. **Acquire or Verify a Number**: Rent from Lacy.ai or add your own as caller ID for outbound.
