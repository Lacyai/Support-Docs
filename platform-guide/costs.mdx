---
title: Costs
description: "Lacy.ai is a pay-as-you-go platform, you only pay for what you use."
---
...
- **Lacy.ai costs**: These are the costs associated with the AI assistant handling the call
- **Carrier costs**: These are the costs associated with the carrier (telephone network) used to make the call

## Lacy.ai costs

This is a fixed cost of USD 0.99,0.49,0.29,0.23/call minute (depending on your plan) which is NOT rounded to the minute.
_Example: for a 30 seconds call duration on the Core plan, you will be billed only $0.24._
