...
title: "Lacy.ai Tool"
icon: "phone"
description: "Learn how to use Lacy.ai triggers and actions in your AI calling flows"
---

# Lacy.ai Tool

The Lacy.ai tool is the core component that connects your AI calling system with automation flows. It enables real-time data exchange between your AI assistants and business systems, allowing for personalized conversations and automated follow-ups.

<Note>
  You can find the Lacy.ai tool prominently displayed at the top of the
...
![Lacy.ai Call Ended Trigger](/resources/Lacy-trigger.jpg)
...
![lacy Action](/resources/lacy-action.jpg)
