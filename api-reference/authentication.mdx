...
The Lacy.ai API uses API keys to authenticate requests. You need to include your API key in the header of each request you make to the API.

## Obtaining an API Key

To obtain an API key:

1. Log in to your Lacy.ai account at [https://app.lacy.ai](https://app.lacy.ai)
...
```bash
curl -X GET "https://api.lacy.ai/api/user/campaigns" \
