...
3. Click **Create new SIP Trunk** and give it a **Friendly name** (e.g., `lacy`)
...
1. Go directly to the Phone Numbers page in your dashboard:
   ...
   **[https://app.lacy.ai/phone-numbers](https://app.lacy.ai/phone-numbers)**
...
2. Click **"Integrate SIP trunk"** (top-right corner of the page)
   ...
   <Frame>
     <img
       src="/resources/twillio-import-lacy-sip1.png"
...
3. Fill in your phone number and SIP credentials:
   ...
   <Frame>
     <img
       src="/resources/twillio-lacy-auth-integration.png"
...
5. Select the **Authorization type**. If you configured IP-based authentication in Step 1, select IP and add these addresses:
   ...
   <Frame>
     <img
       src="/resources/twillio-lacy-credentials-ip-type1.png"
...
6. Select the **country** where your SIP trunk is located.
   ...
   <Frame>
     <img
       src="/resources/twillio-lacy-sip-country.png"
